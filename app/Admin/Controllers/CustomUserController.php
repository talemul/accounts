...
class CustomUserController extends AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function detail($id)
    {
        ...
        $show->field('project_id','Project Name')->as(function ($project_id) {
            $project_name = ProjectInformation::find($project_id);
            $val = '';
            if ($project_name) {
                $val = $project_name->name;
            }
