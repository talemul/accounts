...
class ContraVoucherController extends AdminController
{
    /**
    ...
    protected function form()
    {
        ...
        $form->hidden("transaction_type", __("Transaction Type"))->default('CON')->readonly();
        if ($account_transaction_id) {
...
// Subtable fields
    ...
    /*    $chart_of_account = VChartOfAccountChild::where('code','like','5%')
            ->orwhere('code','like','6%')
                ->get();
       // dd($chart_of_account);
